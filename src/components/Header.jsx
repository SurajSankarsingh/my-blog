  ...
  <header className="text-gray-600 body-font">
    <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
      ...
      <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
        <Link to="/" className="mr-5 text-gray-900 dark:text-gray-300 hover:text-purple-700 dark:hover:text-yellow-600">
          Home
        </Link>
        <div className="relative">
          <button className="mr-5 text-gray-900 dark:text-gray-300 hover:text-purple-700 dark:hover:text-yellow-600 focus:outline-none">
            Categories
          </button>
          <div className="absolute right-0 z-20 w-48 py-2 mt-2 bg-white rounded-md shadow-xl text-gray-900 dark:text-gray-300 hover:text-purple-700 dark:hover:text-yellow-600">
            <Link
              to="/"
